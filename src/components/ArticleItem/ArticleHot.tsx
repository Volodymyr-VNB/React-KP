            ...
            <article className="row-col ar-hot-article">
                ...
                <div className="arc-hot-block ">
                    ...
                    <div className="ar-hot-article1">
                        ...
                        <p className="h4 ar-hot-p ">
                            ...
                            a single stroke at the present moment; and yet I
                ...
                <figure className="arc-hot-block-a">
                    <p className="h4-cat ar-hot-p ">
                        I believe you make your day. You make your life. So much
                        of it is all perception, and this is the form that I
                        built for myself. I have to accept it and work within
                        those compounds, and it’s up to me. <br />{' '}
